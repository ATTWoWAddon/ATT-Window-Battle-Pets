...
if exist "%~1\" (
    ...
    if exist "%~1\Interface\AddOns\ATT-Window-Battle-Pets" (
        rmdir /s /q "%~1\Interface\AddOns\ATT-Window-Battle-Pets"
    )
    if NOT exist "%~1\Interface\AddOns\ATT-Window-Battle-Pets" (
        ...
        mklink /J "%~1\Interface\AddOns\ATT-Window-Battle-Pets" "%cd%"
    )
)
EXIT /B 0
