...
[![Stable Release Date](https://img.shields.io/github/release-date/ATTWoWAddon/ATT-Window-Battle-Pets?logo=github&label=Released&cacheSeconds=600)](https://github.com/ATTWoWAddon/ATT-Window-Battle-Pets/releases)
[![Build Status](https://github.com/ATTWoWAddon/ATT-Window-Battle-Pets/workflows/release/badge.svg)](https://github.com/ATTWoWAddon/ATT-Window-Battle-Pets/actions?workflow=release)
[![Stable Release](https://img.shields.io/github/v/release/ATTWoWAddon/ATT-Window-Battle-Pets?logo=github&label=Stable)](https://github.com/ATTWoWAddon/ATT-Window-Battle-Pets/releases)
![GitHub commits since latest release](https://img.shields.io/github/commits-since/ATTWoWAddon/ATT-Window-Battle-Pets/latest?logo=github)
<br>
[![GitHub Issues or Pull Requests](https://img.shields.io/github/issues/ATTWoWAddon/ATT-Window-Battle-Pets?logo=github&label=Issues)](https://github.com/ATTWoWAddon/ATT-Window-Battle-Pets/issues)
![GitHub Commit Activity](https://img.shields.io/github/commit-activity/m/ATTWoWAddon/ATT-Window-Battle-Pets?logo=github&label=Activity&cacheSeconds=600)
...
## Screenshots
![Standalone Battle Pets window that can also be embedded directly within the Main List. (Currently only enabled in Classic Game Flavors)](.sample.png)
![The addon is an extension for ATT that adds Battle Pets as a quick lookup list for all battle pets in the ATT database sorted by battle pet type!](.sample2.png)
